...
```typescript
import { UiEvent } from 'meta/worlds';
...
```typescript
import { UiEvent, serializable } from 'meta/worlds';
...
```typescript
import { component, Component, OnEntityStartEvent, subscribe, CustomUiComponent } from 'meta/worlds';
import {
  gameMenuVM,
  onStartGameClicked,
  onPauseClicked,
