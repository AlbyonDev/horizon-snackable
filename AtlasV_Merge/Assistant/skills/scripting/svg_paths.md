...
private drawScaledAsteroid(): void {
  ...
  this.builder.pushRotate(asteroid.rotation, new Vec2(0, 0));
  this.builder.pushScale(new Vec2(asteroid.size, asteroid.size), new Vec2(0, 0));  // Scale the normalized path
