...
this.builder.drawText(String(this.score), new Rectangle(80, 10, 100, 30), 24, textBrush, font);
```
...
this.builder.drawRect(scoreLabelBrush, null, new Rectangle(10, 8, 70, 24));
this.builder.drawText(String(this.score), new Rectangle(85, 10, 100, 30), 24, textBrush, font);
```
